...
### 1. 🪟 Sleek Frameless Titlebar & Window Controls
* **Mac-Style Traffic Lights:** Beautiful close (`#ff5f56`), minimize (`#ffbd2e`), and maximize (`#27c93f`) window controls with bidirectional maximize/restore toggling.
...
### 4. ⚙️ Hardcore V8 Memory Cap & Win32 Working Set Trimmer
